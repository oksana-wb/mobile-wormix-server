...
COPY (SELECT id, profile_id, weapon_count, case
    ...
    when weapon_id = 18 then 25
    when weapon_id = 20 then 19
    when weapon_id = 22 then 26
    else weapon_id
end as weapon_id FROM wormswar.backpack_item_0 WHERE weapon_id != 21 and weapon_id != 17) TO '/home/postgres/truncate/live_backpack_item_0.copy';
COPY (SELECT id, profile_id, weapon_count, case
    when weapon_id = 6 then 7
    when weapon_id = 8 then 9
    when weapon_id = 13 then 14
...
end as weapon_id FROM wormswar.backpack_item_1 WHERE weapon_id != 21 and weapon_id != 17) TO '/home/postgres/truncate/live_backpack_item_1.copy';
COPY (SELECT id, profile_id, weapon_count, case
    when weapon_id = 6 then 7
    when weapon_id = 8 then 9
    when weapon_id = 13 then 14
...
end as weapon_id FROM wormswar.backpack_item_2 WHERE weapon_id != 21 and weapon_id != 17) TO '/home/postgres/truncate/live_backpack_item_2.copy';
COPY (SELECT id, profile_id, weapon_count, case
    when weapon_id = 6 then 7
    when weapon_id = 8 then 9
    when weapon_id = 13 then 14
...
end as weapon_id FROM wormswar.backpack_item_3 WHERE weapon_id != 21 and weapon_id != 17) TO '/home/postgres/truncate/live_backpack_item_3.copy';
