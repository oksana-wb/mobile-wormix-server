 ...
 *         Created: 26.08.11 16:50
 */
@Component
public class DispatchLastCommandHandler extends AbstractHandler{
    ...
    public PvpBattleActionEnum handle(PvpUser profile, PvpCommandI command, PvpBattleActionEnum action, BattleBuffer battleBuffer) {
        ...
        if(cmd != null){
            pvpService.dispatchToParticipants(battleBuffer.getTurningPvpId(), battleBuffer, cmd);
        }
        return null;
