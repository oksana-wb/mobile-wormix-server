 ...
 */
public class WhoPumpedReactionByDaysKeeper extends DefaultKeeperImpl {

    @Override
    public void writeObject(Object o) throws IOException, ClassCastException {
        List<Map<Long, Object>> whoPumpedRateByDays = (List<Map<Long, Object>>) o;
        out.writeInt(whoPumpedRateByDays.size());
    ...
    public <T> T readObject(T objectClass) throws IOException, ClassNotFoundException, ClassCastException {
        List<Map<Long, Object>> list = new CopyOnWriteArrayList<Map<Long, Object>>();
        Calendar cal = Calendar.getInstance();
